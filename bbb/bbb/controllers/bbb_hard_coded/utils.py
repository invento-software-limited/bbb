...
from erpnext.accounts.doctype.pricing_rule.price_rule_on_tag import apply_pricing_rule_on_tag
...
apply_on_table = {"Item Code": "items", "Item Group": "item_groups", "Brand": "brands", "Tag": "tags"}
...
def get_pricing_rules(args, doc=None):
	...
	for apply_on in ["Item Code", "Item Group", "Brand", "Tag", "Transaction"]:
...
def _get_pricing_rules(apply_on, args, values):
	...
	# rabiul
	if apply_on_field in ["item_code", "brand", "tag"]:
	...
	elif apply_on_field == "transaction":
		conditions = "apply_on = 'Transaction' and applicable_for='Tag'"
...
def get_other_conditions(conditions, values, args):
	# rabiul
	for field in ["company", "customer", "supplier", "campaign", "sales_partner", "tag"]:
		if args.get(field):
