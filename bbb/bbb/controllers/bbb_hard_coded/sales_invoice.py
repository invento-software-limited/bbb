...
class SalesInvoice(SellingController):
						...
						self.get_gl_dict(
							{
								...
								"credit": (payment_mode.base_amount + flt(self.total_advance)),
								"credit_in_account_currency": (payment_mode.base_amount + flt(self.total_advance))
								if self.party_account_currency == self.company_currency
						...
						self.get_gl_dict(
							{
								...
								"against": self.customer,
								"debit": payment_mode.base_amount + flt(self.total_advance),
								"debit_in_account_currency": payment_mode.base_amount + flt(self.total_advance)
								if payment_mode_account_currency == self.company_currency
								else (payment_mode.amount + flt(self.total_advance)),
								"cost_center": self.cost_center,
							},
	...
	def make_gle_for_change_amount(self, gl_entries):
		self.change_amount = (self.paid_amount + self.total_advance) - self.rounded_total
		self.base_change_amount = (self.paid_amount + self.total_advance) - self.rounded_total
		frappe.db.set_value('Sales Invoice', self.name, 'change_amount', ((self.paid_amount + self.total_advance) - self.rounded_total))
		frappe.db.set_value('Sales Invoice', self.name, 'base_change_amount', ((self.paid_amount + self.total_advance) - self.rounded_total))
