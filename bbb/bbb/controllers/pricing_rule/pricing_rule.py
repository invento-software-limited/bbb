...
apply_on_dict = {"Item Code": "items", "Item Group": "item_groups", "Brand": "brands", "Tag": "tags"}
...
def apply_price_discount_rule(pricing_rule, item_details, args):
	tag_discount_amount = None
	try:
		tag_discount_amount = frappe.db.get_value("Item", {'item_code': args.get("item_code")}, "discount_amount")
	except:
		pass
	...
	for apply_on in ["Discount Amount", "Discount Percentage"]:
		...
		if pricing_rule.apply_discount_on_rate and item_details.get("discount_percentage"):
			...
			if pricing_rule.apply_on == "Tag":
				value = tag_discount_amount
