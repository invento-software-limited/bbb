...
def get_invoice_data(filters):
    ...
    query_result = frappe.db.sql("""
    		select
    			...
    			item.brand, item.item_group, item.item_name, bin.actual_qty as current_stock, (sales_invoice_item.amount -(sales_invoice_item.qty * item.buying_rate)) as profit_loss
