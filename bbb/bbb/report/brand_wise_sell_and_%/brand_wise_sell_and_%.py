...
def get_columns():
    ...
    columns = [
        ...
        {"label": _("Bill amount"), "fieldname": "mrp_total", "fieldtype": "Currency", "width": 180,
         "convertible": "rate", "options": "currency"},
        {"label": _("Unit Qty"), "fieldname": "total_item_qty", "fieldtype": "Int", "width": 180,
         "convertible": "rate", "options": "currency"},
        {"label": _("Sales %"), "fieldname": "sales_ratio", "fieldtype": "Text", "width": 150, },
    ]
    return columns
...
def get_invoice_data(filters):
    ...
    for result in query_result:
        if data.get(result.get('brand')):
            ...
            pos_data['total_sell_amount'] = pos_data['total_sell_amount'] + result['grand_total']
