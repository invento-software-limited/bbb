...
erpnext.taxes_and_totals = erpnext.payments.extend({
	...
	apply_pricing_rule_on_item: function(item) {
		...
		var today = new Date();
		var item_doc = frappe.db.get_doc("Item", null, {'item_code': item.item_code})
		console.log('item_doc ', item_doc);
		console.log('item ');
		if(item_doc.start_date !== undefined && item_doc.end_date !== undefined && item_doc.discount_amount !== undefined && today >= item_doc.start_date && today <= item_doc.end_date){
			frappe.model.set_value("POS Invoice Item", item_row.child_docname, 'rate', (mrp-discount_amount));
		}else{
