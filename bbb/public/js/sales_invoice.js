...
frappe.ui.form.on('Sales Invoice', {
	...
	set_timesheet_data(frm, timesheets) {
	...
	append_time_log(frm, time_log, exchange_rate) {
	...
	create_invoice_discounting(frm) {
		frappe.model.open_mapped_doc({
